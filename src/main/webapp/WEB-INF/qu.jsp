...
<form action="" method="POST" id="deleteForm">
	...
	<c:forEach items="${requestScope.querys}" var="emp">
		<tr>
			...
			<c:set var="gre" scope="request" value="${emp.gre}"></c:set>
			<td>
			<img alt="" height="50px" width="50px" src="xiazaizai?path=<%=java.net.URLEncoder.encode(String.valueOf(request.getAttribute("hs")))%>&gre=<%=java.net.URLEncoder.encode(String.valueOf(request.getAttribute("gre")))%>">
